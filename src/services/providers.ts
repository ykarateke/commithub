...
export const providers: readonly ProviderDefinition[] = [
	...
	{ id: 'deepseek', label: 'DeepSeek', description: 'DeepSeek Flash and V4 Pro models', protocol: 'openai', defaultBaseUrl: 'https://api.deepseek.com', defaultModel: 'deepseek-flash', requiresApiKey: true, supportsModelDiscovery: true },
